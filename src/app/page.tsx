  ...
  return (
    <div className="w-full max-w-lg mx-auto space-y-12">
      <div className="text-center space-y-4">
        <h1 className="text-4xl md:text-5xl tracking-tight text-[var(--color-primary)] font-bold">
          {t('landing.title')}
        </h1>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        >
          <div className="space-y-2">
            <h2 className="text-2xl font-display text-[var(--color-text)] group-hover:text-[var(--color-primary)] transition-colors">
              {t('landing.cta_create')}
            </h2>
            <p className="text-[var(--color-text-muted)] text-sm">{t('landing.cta_create_desc')}</p>
          </div>
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-[var(--color-text-muted)] text-sm">{t('landing.cta_access_desc')}</p>
          </div>
